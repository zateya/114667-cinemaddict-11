...
const createFilmsTemplate = () => {
  ...
  const filmsListTemplate = createFilmsListTemplate(FILMS_COUNT);
  const showMoreButtonTemplate = createShowMoreButtonTemplate();
  const filmsRatedListTemplate = createFilmsListTemplate(FILMS_RATED_COUNT);
  const filmsCommentedListTemplate = createFilmsListTemplate(FILMS_COMMENTED_COUNT);
...
const createFilmDetailsTemplate = () => {
  return (
    `<section class="film-details visually-hidden"> <!-- скрыт классом visually-hidden -->
